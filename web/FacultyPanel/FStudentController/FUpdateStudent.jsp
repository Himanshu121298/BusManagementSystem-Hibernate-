    ...
    <body>
        ...
        <section>
            <div class="container-fluid">
                <div class="container">
                    <div class="formBox">
                        <form action="../../FStuUpdate" method="post">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="inputBox">
                                        ...
                                        <input type="text" value="<%=student.getName()%>" name="name" class="input" readonly>
                                    </div>
                                </div>	
                                <div class="col-sm-6">
                                    <div class="inputBox">
                                        <div class="inputText">UserID</div>
                                        <input type="text" value="<%=student.getUsername()%>" name="username" class="input" readonly>
                                    </div>
                                </div>	
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="inputBox">
                                        ...
                                        <input type="text" value="<%=student.getPassword()%>" name="password" class="input" readonly>
                                    </div>
                                </div>	
                                <div class="col-sm-6">
                                    <div class="inputBox">
                                        <div class="inputText">AccountType</div>
                                        <input type="text" value="<%=student.getAccount() %>" name="account" class="input" readonly>
                                    </div>
                                </div>	
                            </div>
