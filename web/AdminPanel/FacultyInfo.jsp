            ...
            <div class="container">
                ...
                <div class="box">
                    <div class="content">
                        ...
                        <h3>UserId : <%=student.getUsername()%></h3>
                        <h3>Account Type : <%=student.getAccount()%></h3>
                        <p><b><%=student.getName()%></b> has work tirelessly to both raise his level of knowledge of a complex problem .</p>
                        <a href="FacultyController/UpdateFaculty.jsp?id=<%=student.getS_id()%>">Update</a>
                        <a href="FacultyController/DeleteFaculty.jsp?id=<%=student.getS_id()%>">Delete</a>
                    </div>
                </div>
                <%
                    }
