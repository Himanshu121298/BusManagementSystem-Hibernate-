        ...
        <div class="container">
            ...
            <div class="box">
                <div class="content">
                    ...
                    <a href="FStudentController/FUpdateStudent.jsp?id=<%=student.getS_id()%>">Update</a>
        ...
        <div class="container">
            ...
            <div class="box">
                <div class="content">
                    ...
                    <h3>Account Type : <%=student.getAccount()%></h3>
                    <p><b><%=student.getName()%></b> is enrolled in our transportation management and pickup location is <%=student.getAddress()%> to College.</p>
                    <a href="FStudentController/UpdateStudent.jsp?id=<%=student.getS_id()%>">Update</a>
                </div>
            </div>
            <%
                }
